import { ValidationErrors, IValidateAsync } from '../validation';
 ...
 */
export declare class ValidationState<TValue>
  implements IValidationState<TValue>
{
  /** validator function */
  readonly validate: IValidateAsync<TValue>;
  /** value */
  readonly value: TValue;
  constructor(
    /** validator function */
    validate: IValidateAsync<TValue>,
    /** value */
    value?: TValue,
