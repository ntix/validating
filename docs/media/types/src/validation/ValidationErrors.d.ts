...
export type ValidationErrors<TValue> = (TValue extends boolean ? IStandardAnyErrors : TValue extends number ? IStandardNumberErrors : TValue extends string ? IStandardStringErrors : {
    [P in {
