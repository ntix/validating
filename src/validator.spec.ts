...
describe('validator', () => {
  ...
  it('value min/max length does not allow empty', async () => {
    const result = {
...
const validateUserRegistration: IValidate<IUserRegistration> = (value) => {
  if (value == null) return StandardErrors.not.null;
...
const validateUserName: IValidate<string> = (value) => {
  if (value == null) return StandardErrors.not.null;
...
const validatePassword: IValidate<string> = (value) => {
  if (value == null) return StandardErrors.not.null;
